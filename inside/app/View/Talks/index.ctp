<div class="talks index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('strat'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($talk['Talk']['place']); ?>&nbsp;</td>
		<td><?php echo h($talk['Talk']['strat']); ?>&nbsp;</td>
		<td><?php echo h($talk['Talk']['end']); ?>&nbsp;</td>
		<td><?php echo h($talk['Talk']['name']); ?>&nbsp;</td>
		<td><?php echo h($talk['Talk']['description']); ?>&nbsp;</td>
		<td><?php echo h($talk['Talk']['picture']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $talk['Talk']['id']), array(), __('Are you sure you want to delete # %s?', $talk['Talk']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
