...
<?php echo $this->Form->create('SpeakersHasTalk'); ?>
	<fieldset>
		<legend><?php echo __('Edit Speakers Has Talk'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SpeakersHasTalk.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SpeakersHasTalk.id'))); ?></li>
